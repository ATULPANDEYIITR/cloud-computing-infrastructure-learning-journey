...
| -----: | ------ | ----------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
|      1 | Day 01 | Introduction to Cloud Computing           | Definition of cloud computing, evolution of computing infrastructure, traditional infrastructure vs cloud infrastructure, reasons for cloud adoption, basic cloud terminology | Web Browser, Cloud Console Concepts             |
|      2 | Day 02 | History and Evolution of Computing        | Mainframes, personal computing, client-server architecture, enterprise data centers, distributed computing, virtualization, cloud computing evolution                         | VirtualBox Concepts                             |
|      3 | Day 03 | Cloud Computing Characteristics           | On-demand self-service, broad network access, resource pooling, rapid elasticity, measured service, multi-tenancy                                                             | Cloud Provider Console                          |
|      4 | Day 04 | Cloud Service Models                      | IaaS, PaaS, SaaS, FaaS, CaaS, responsibility boundaries, service model comparisons                                                                                            | AWS, Azure, Google Cloud Concepts               |
|      5 | Day 05 | Cloud Deployment Models                   | Public cloud, private cloud, hybrid cloud, multi-cloud, community cloud, use cases and trade-offs                                                                             | AWS, Azure, Google Cloud Concepts               |
|      6 | Day 06 | Cloud Economics Fundamentals              | CAPEX vs OPEX, pay-as-you-go, consumption pricing, total cost of ownership, infrastructure budgeting                                                                          | Cloud Pricing Calculators                       |
|      7 | Day 07 | Cloud Providers and Global Infrastructure | Major cloud providers, regions, availability zones, edge locations, points of presence, global infrastructure                                                                 | AWS Console, Azure Portal, Google Cloud Console |
...
| 14 | Day 14 | Linux Command Line | Navigation, file operations, search commands, text processing, system commands | Bash |
| 15 | Day 15 | Linux Users and Permissions | Users, groups, ownership, permissions, sudo, access control | Linux Terminal |
| 16 | Day 16 | Linux Processes and Services | Processes, process IDs, signals, services, daemons, systemd | ps, top, systemctl |
| 17 | Day 17 | Linux Package Management | Package repositories, dependencies, installation, upgrades, package managers | apt, yum, dnf |
...
| 24 | Day 24 | IP Addressing | IPv4, IPv6, public IP, private IP, reserved addresses, IP allocation | ipcalc |
| 25 | Day 25 | Subnetting and CIDR | Subnet masks, CIDR notation, network ranges, host ranges, subnet calculations | ipcalc, Python |
| 26 | Day 26 | TCP and UDP | Connection establishment, three-way handshake, reliability, ports, UDP communication | Wireshark, netcat |
| 27 | Day 27 | DNS | DNS hierarchy, recursive resolution, authoritative servers, DNS records, caching | nslookup, dig |
...
| 34 | Day 34 | Server Virtualization | Resource sharing, VM isolation, overcommitment, host management | VMware Concepts |
| 35 | Day 35 | Storage Virtualization | Logical volumes, virtual disks, storage pools, abstraction layers | LVM |
| 36 | Day 36 | Network Virtualization | Virtual switches, virtual networks, overlays, software-defined networking basics | VirtualBox Networking |
| 37 | Day 37 | Containers vs Virtual Machines | Isolation, performance, portability, resource utilization, workload comparison | Docker Concepts |
...
| 44 | Day 44 | Auto Scaling | Scaling groups, scaling policies, metrics, thresholds, automatic capacity changes | AWS Auto Scaling |
| 45 | Day 45 | Serverless Computing | Functions, event triggers, execution environments, cold starts, scaling | AWS Lambda |
| 46 | Day 46 | Cloud Storage Fundamentals | Durability, availability, replication, redundancy, storage classes | AWS S3 |
| 47 | Day 47 | Object Storage | Buckets, objects, metadata, versioning, lifecycle management, access policies | AWS S3 |
| 48 | Day 48 | Block Storage | Volumes, snapshots, IOPS, throughput, disk attachment | AWS EBS |
| 49 | Day 49 | File Storage | Shared storage, network file systems, distributed file systems | AWS EFS |
| 50 | Day 50 | Storage Performance and Optimization | IOPS, throughput, latency, caching, storage tiers, cost-performance trade-offs | CloudWatch Concepts |
| 51 | Day 51 | Backup Architecture | Full backups, incremental backups, snapshots, retention policies, backup automation | AWS Backup |
| 52 | Day 52 | Disaster Recovery | RPO, RTO, backup and restore, pilot light, warm standby, active-active architecture | AWS Backup Concepts |
...
| 59 | Day 59 | Database Replication | Primary-replica architecture, synchronous replication, asynchronous replication, read replicas | PostgreSQL, AWS RDS |
| 60 | Day 60 | Database High Availability | Multi-zone databases, failover, clustering, redundancy, availability patterns | AWS RDS Multi-AZ |
| 61 | Day 61 | NoSQL Infrastructure | Key-value, document, wide-column, graph databases, eventual consistency | MongoDB, DynamoDB Concepts |
| 62 | Day 62 | Database Scaling | Vertical scaling, horizontal scaling, partitioning, sharding, read replicas | PostgreSQL Concepts |
...
| 69 | Day 69 | Cloud Network Security | Security groups, firewalls, network ACLs, traffic filtering | AWS VPC Security Groups |
| 70 | Day 70 | Encryption Fundamentals | Encryption at rest, encryption in transit, symmetric encryption, asymmetric encryption | OpenSSL Concepts |
| 71 | Day 71 | Key and Secrets Management | Encryption keys, key rotation, secrets storage, certificates | AWS KMS, AWS Secrets Manager |
| 72 | Day 72 | Security Monitoring and Auditing | Audit logs, access logs, security alerts, anomaly detection | AWS CloudTrail |
...
| 79 | Day 79 | Docker Container Management | Container lifecycle, environment variables, commands, logs, inspection | Docker CLI |
| 80 | Day 80 | Docker Networking | Bridge networks, host networking, container communication, custom networks | Docker |
| 81 | Day 81 | Docker Storage and Volumes | Volumes, bind mounts, persistent data, volume management | Docker Volumes |
| 82 | Day 82 | Docker Compose | Multi-container applications, services, networks, volumes, environment configuration | Docker Compose |
...
| 89 | Day 89 | Deployments and ReplicaSets | Declarative deployment, replicas, rolling updates, rollbacks | Kubernetes |
| 90 | Day 90 | Kubernetes Services | ClusterIP, NodePort, LoadBalancer, service discovery, DNS | Kubernetes |
| 91 | Day 91 | ConfigMaps and Secrets | Configuration management, sensitive configuration, environment variables | Kubernetes |
| 92 | Day 92 | Kubernetes Storage | Persistent volumes, persistent volume claims, storage classes, StatefulSets | Kubernetes |
...
| 99 | Day 99 | Terraform Modules | Reusable modules, module structure, inputs, outputs, infrastructure abstraction | Terraform |
| 100 | Day 100 | Advanced Terraform | Dependencies, workspaces, lifecycle rules, provisioners, dynamic blocks | Terraform |
| 101 | Day 101 | Configuration Management | Infrastructure configuration, server configuration, idempotency | Ansible Concepts |
| 102 | Day 102 | Ansible Fundamentals | Inventories, playbooks, tasks, modules, variables | Ansible |
...
| 109 | Day 109 | Monitoring Fundamentals | Metrics, monitoring systems, dashboards, alerts, infrastructure health | Prometheus |
...
| 116 | Day 116 | Distributed Systems Advanced Concepts | CAP theorem, consensus, leader election, eventual consistency, quorum systems | etcd, Redis Concepts |
| 117 | Day 117 | Microservices Infrastructure | Service discovery, API gateways, service communication, configuration, resilience | Kubernetes, Nginx |
| 118 | Day 118 | Event-Driven Architecture | Events, message queues, pub/sub, event streams, asynchronous systems | Apache Kafka, RabbitMQ |
| 119 | Day 119 | Hybrid, Multi-Cloud and FinOps | Hybrid infrastructure, multi-cloud strategy, cloud portability, cost optimization, resource rightsizing, tagging | AWS, Azure, Google Cloud, Cloud Cost Tools |
| 120 | Day 120 | Extreme Advanced Cloud Infrastructure Capstone | Design enterprise-grade cloud infrastructure combining distributed systems, Kubernetes, IaC, DevOps, security, observability, high availability, disaster recovery, multi-region architecture, multi-cloud strategy, event-driven systems, and cloud cost optimization | AWS, Kubernetes, Terraform, Ansible, Docker, GitHub Actions, Prometheus, Grafana |
